class MapaSismos {
  ...
  obtenerColorMagnitud(magnitud) {
    if (magnitud < 3.0) return '#2ecc71'; // Verde - Muy leve
    if (magnitud < 5.0) return '#f1c40f'; // Amarillo - Leve
    if (magnitud < 6.0) return '#e67e22'; // Naranja - Moderado
    if (magnitud < 7.0) return '#e74c3c'; // Rojo - Fuerte
    return '#c0392b'; // Rojo oscuro - Muy fuerte
  }
  ...
  mostrarError(mensaje) {
    // Aquí podrías mejorar la notificación al usuario
